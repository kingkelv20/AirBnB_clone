...
class TestAmenity(unittest.TestCase):
    """ a test for the Amenity calss in side amenity module """

    def test_attributes(self):
        """ tests the attributes of the class """
        u1 = Amenity()
        dc = {"id": u1.id, "created_at": u1.created_at.isoformat(),
              "updated_at": u1.updated_at.isoformat(), "__class__": "Amenity"}
        self.assertEqual(u1.to_dict(), dc)

        u2 = Amenity(**u1.to_dict())
    ...
    def test_str(self):
        ...
        b1 = Amenity()
        self.assertEqual(str(b1), f"[Amenity] ({b1.id}) {b1.__dict__}")
    ...
    def test_to_dict(self):
        ...
        dc = {'id': b1.id, 'created_at': b1.created_at.isoformat(),
              ...
              '__class__': 'Amenity', "name": "my_name"}
        ...
        dc = {'id': b1.id, 'created_at': b1.created_at.isoformat(),
              'updated_at': b1.updated_at.isoformat(),
              '__class__': 'Amenity', 'name': 'my_name', 'my_number': 89}
        self.assertEqual(b1.to_dict(), dc)
        a = b1.to_dict()
    ...
    def test_amenity_attributes(self):
        ...
        dc = {'id': u1.id, 'created_at': u1.created_at.isoformat(),
              ...
              '__class__': 'Amenity', "name": "kuriftu"}
        self.assertEqual(u1.to_dict(), dc)
